<footer class="dark-footer skin-dark-footer style-2">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="footer_widget">
                        ...
                        <div class="address_infos">
                            <ul>
                                <li>CÔNG TY CỔ PHẦN ĐẦU TƯ VÀ DỊCH VỤ F&B VIỆT NAM<br></li>
                                <li>Mã số thuế: 316657994<br></li>
                                <li><i class="fas fa-map-marker-alt"></i>Địa chỉ ĐKKD: {{ $setting->diachi ?? ""}}<br></li>
                ...
                <div class="col-lg-4 col-md-2">
                    <div class="footer_widget">
                        <h2 class="widget_title">GOOD FOOD</h2>
                        <!-- <ul class="footer-menu">
                        ...
                        <p class="text-sub">Nơi trải nghiệm sự thăng hoa của ẩm thực, mang hương vị nhà hàng đến với gia đình bạn.</p>
                        <img alt="Đã đăng ký" src="https://static.tastykitchen.vn/images/bo-cong-thuong.png" width="220" height="84" style="margin-top: 15px">
                    </div>
                </div>

                <div class="col-lg-4 col-md-2">
                    <div class="footer_widget">
                        <h4 class="widget_title">Hỗ trợ khách hàng</h4>
                        <ul class="footer-menu">
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col text-center">
					<p class="mb-0">Một sản phẩm của <a href="https://goodfood.nguyendangtrinh.me">Good Food</a>.</p>
				</div>

				<div class="">
					<ul class="footer_social_links">
						<li><a href="https://facebook.com/DangTrinh3006"><i class="fa-brands fa-facebook-f"></i></a></li>
						<li><a href="https://instagram.com/DangTrinh3006"><i class="fa-brands fa-instagram"></i></a></li>
    ...
    <a href="" class="icon-back-top" style="display: inline;"></a>
