                                ...
                                <div class="single_team_caption">
                                    <div class="review_author_box">
                                        <div class="reviews_caption">
                                            <h4 class="testi2_title">HƯƠNG VỊ TỰ NHIÊN</h4>
                                        </div>
                                    </div>
                                    <p class="teams_description">Hương vị thuần khiết từ nguyên liệu tự nhiên và tươi ngon được tuyển chọn theo tiêu chuẩn cao từ những nông trại uy tín hàng đầu Việt Nam.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="single_teams_wraps">
                                <div class="single_team_caption">
                                    <div class="review_author_box">
                                        <div class="reviews_caption">
                                            <h4 class="testi2_title">CÔNG THỨC MÓN ĂN</h4>
                                        </div>
                                    </div>
                                    <p class="teams_description">Công thức món đặc biệt từ những đầu bếp nhiều năm kinh nghiệm, đam mê và sáng tạo trong nghiên cứu không ngừng.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
                <div class="single_testi_box">
                    <div class="row">
                        <div class="col-lg-5 col-md-5">
                            <div class="single_teams_thumb">
                                <img src="{{ asset('img/gioithieu.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7">
                            <div class="single_teams_wraps">
                                <div class="single_team_caption">
                                    <div class="review_author_box">
                                        <div class="reviews_caption">
                                            <h4 class="testi2_title">ĐA DẠNG</h4>
                                        </div>
                                    </div>
                                    <p class="teams_description">Đa dạng & nâng cao tiêu chuẩn bữa ăn delivery hàng ngày trở nên tinh tế & đáng trải nghiệm hơn.
                                    </p>
                                </div>
                            </div>
                        </div>
