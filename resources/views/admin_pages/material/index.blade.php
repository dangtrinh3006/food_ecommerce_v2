...
<div class="container-fluid coupon form_ql">
    <div class="card_1">
        <h3 class="card-title">Nguyên liệu</h3>
            <a href="{{ route('material.addview') }}" class="btn btn-primary">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <td>
                        ...
                        <a href="{{ route('material.editview', $item->slug) }}" class="btn btn-info mgr-5" id="edit">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>

                        <a href="{{ route('material.delete', $item->id) }}" class="btn btn-danger mgr-5" id="edit">
