...
class OrderController extends Controller
{
   ...
   function addOrder(Request $req)
   {
       ...
       $order->madh=$req->madh;
       $order->hoten=$req->hoten;
       $order->diachi=$req->diachi;
       $order->email=$req->email;
       $order->ghichu=$req->ghichu;
       $order->dienthoai=$req->dienthoai;
       $order->id_nhanvien=$req->id_nhanvien;
       $order->id_khachhang=$req->id_khachhang;
       $order->httt=$req->httt;
       $order->ngaytao=$req->ngaytao;
       $order->tongdonhang=$req->tongdonhang;
       $order->tongtien=$req->tongtien;
       $order->id_coupon=$req->id_coupon;
       $order->id_feeship=$req->id_feeship;
       $order->trangthaithanhtoan=$req->trangthaithanhtoan;
       $order->trangthai=$req->trangthai;
   ...
   function updateOrderAPI(Request $req){
       ...
       $order->tongtien=$req->tongtien;
       $order->id_coupon=$req->id_coupon;
       $order->id_freeship=$req->id_feeship;
       $order->trangthaithanhtoan=$req->trangthaithanhtoan;
       $order->trangthai=$req->trangthai;
