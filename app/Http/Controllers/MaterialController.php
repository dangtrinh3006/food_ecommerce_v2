...
class MaterialController extends Controller
{
   ...
   function addMaterial(Request $req)
   {
       ...
       $material->ten_nglieu=$req->ten_nglieu;
       $material->gia_nhap=$req->gia_nhap;
       $material->hinh_anh=$req->hinh_anh;
       $material->so_luong=$req->so_luong; 
       $material->don_vi_nglieu=$req->don_vi_nglieu;
       $material->ngay_nhap=$req->ngay_nhap;
       $material->ngay_het_han=$req->ngay_het_han;
       $material->slug=$req->slug;
       $material->trang_thai=$req->trang_thai;
   ...
   function updateMaterialAPI(Request $req){
       $material = Materials::find($req->id);
